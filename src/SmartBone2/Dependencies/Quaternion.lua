...
local function fromToRotation(fromDirection: Vector3, toDirection: Vector3)
	local axis: Vector3 = fromDirection:Cross(toDirection)
    local angle: number = fromDirection:Angle(toDirection)
    return Quaternion.fromAxisAngleFast(axis, angle)
end
